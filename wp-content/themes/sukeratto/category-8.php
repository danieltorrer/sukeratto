						...
						<div class="post-item boxed">
							...
							<ul class="post-meta-links clearfix">
								...
								<li class="post-meta post-author">
									...
									foreach ((get_the_category()) as $childcat) {
										if (cat_is_ancestor_of(3, $childcat)) {
											?>
											<span><a href="<?php get_category_link($childcat->cat_ID);?>" > <?= $childcat->cat_name?></a></span>
											<?php
										}
									}
									 ?>
								...
								<li class="post-meta post-read last">
									<a class="btn btn-icon-left" href="<?php the_permalink() ?>" hidefocus="true" style="outline: none; opacity: 0.8;">
										<span>Ver más</span>
									</a>
								</li>
							</ul>
